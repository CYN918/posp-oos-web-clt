...
export class CouPon extends Component {
    ...
    public render() {
        ...
        const {buyAmount = '', validDay = '', rate = '', record = '', state = ''} = currentItem;
        return (
            <Fragment>
                <Row>
                    <Col span={7}>
                ...
                >
                  <Spin tip="加载中..." spinning={policyLoading}>
                    ...
                    <Form.Item label="有效期" labelCol={{span: 6}} wrapperCol={{span: 16}}>
                    ...
                    <Form.Item label="选择状态" labelCol={{span: 6}} wrapperCol={{span: 16}}>
                        <Select value={state} style={{width: 300}} onChange={this.handleChangeState}>    
