...
const objectKeys = Object.keys || function (obj: object) {
    const keys: string[] = [];
...
const stringify = function (obj: object, opts?: any) {
    ...
    const cmp = opts.cmp && ((f) => (node) => (a, b) => f({key: a, value: node[a]}, {
        key: b,
        value: node[b]
    }))(opts.cmp);
    ...
    return (function stringifyFn(parent: any, key: any, node?: any, level?: any) {
...
export const parsed = (obj: object) => {
